<div class="body_wrapper">
    <header class="header_area bgblack">
        <nav class="navbar navbar-expand-lg menu_one">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><img src="img/logon.webp " srcset="img/logon.webp 3x" alt="logo"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto menu">
                                        ...
                                        <ul class="dropdown-menu scroll">
                                            ...
                                            <li class="nav-item">
                                                <a href="home-payment-processing.html" class="item">
                                                    <span class="img">
                                                        <img src="img/mega-menu-img/home16.jpg" alt="home16">
                                                    </span>
                                                    <span class="text">
                                                        Payment Processing
                                                    </span>
                                            ...
                                            <li class="nav-item">
                                                <a href="home-mail.html" class="item">
                                                    <span class="img">
                                                        <img src="img/mega-menu-img/home9.jpg" alt="home9">
                                                    </span>
                                                    <span class="text">
                                                        Email Client
                                                    </span>
                                            ...
                                            <li class="nav-item">
                                                <a href="home-startup.html" class="item">
                                                    <span class="img">
                                                        <img src="img/mega-menu-img/home15.jpg" alt="home15">
                                                    </span>
                                                    <span class="text">
                                                        Startup
                                                    </span>
                        ...
                        <li class="dropdown submenu nav-item"><a title="Pages" class="dropdown-toggle nav-link"
                            ...
                            <ul role="menu" class=" dropdown-menu">
                                ...
                                <li class="nav-item"><a title="About" class="nav-link" href="about.html">About</a>
                                </li>
                    ...
                    <div class="tracking_btn">
                        <a class="er_btn btn_hover" href="#get-app">Start your free trail</a>
                    </div>
                </div>
            </div>
        </nav>
